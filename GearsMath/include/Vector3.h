#ifndef GEARS_VECTOR3_H
#define GEARS_VECTOR3_H
...
public:
    ...
    static Vector3 Divide(const Vector3& v1, const Vector3 v2, float threshold = Mathf::EPSILON);
