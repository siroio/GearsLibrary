...
#pragma comment(lib, "PhysXCommon.lib")
#pragma comment(lib, "PhysXCooking.lib")
#pragma comment(lib, "PhysXExtensions_static.lib")
#pragma comment(lib, "PhysXFoundation.lib")
#pragma comment(lib, "PhysXPvdSDK_static.lib")
#pragma comment(lib, "PhysXTask_static.lib")
#pragma comment(lib, "SceneQuery_static.lib")
#pragma comment(lib, "SimulationController_static.lib")
#endif // _DEBUG
